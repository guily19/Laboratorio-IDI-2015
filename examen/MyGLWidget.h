...
class MyGLWidget : public QGLWidget 
{
  ...
  private:
    void createBuffers ();
    void loadShaders ();
    void projectTransform (float angle, float rav, float znear, float zfar);
    void viewTransform ();
    ...
    GLuint transLoc, projLoc, viewLoc, colorLlumLoc;
    ...
    int xClick, yClick;
    float angleX, angleY, movX, movZ;
    bool esGeneral, llumBlanca;
};
