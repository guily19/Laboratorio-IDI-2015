...
// // escric per pantalla les coordenades del vèrtex 
//     std::cout << "(x, y, z) = (" << homerProves.vertices()[i] << ", "<< homerProves.vertices()[i+1] << ", "<< homerProves.vertices()[i+2] << ")" << std::endl;
//   }
...
void MyGLWidget::carregaShaders() 
{
  ...
  // // Obtenim identificador per al atribut colorHom
  // colorHomLoc = glGetAttribLocation(program->programId(),"colorHom");

  // vertexHomLoc = glGetAttribLocation(program->programId(),"vertexHom");
